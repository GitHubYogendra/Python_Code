    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shippingPrice', models.DecimalField(blank=True, decimal_places=2, max_digits=11, null=True)),
                ('totalPrice', models.DecimalField(blank=True, decimal_places=2, max_digits=11, null=True)),
